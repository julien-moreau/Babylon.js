...
import type { ParticleSystemSet } from "./particleSystemSet";
...
export class BaseParticleSystem implements IClipPlanesHolder {
    ...
    /** @internal */
    public _sourceParticleSystemSet: Nullable<ParticleSystemSet> = null;

    /**
     * Gets the source Particle System Set if the particle system was generated by a node particle system set or by the Particles Helper.
     */
    public get sourceParticleSystemSet(): Nullable<ParticleSystemSet> {
        return this._sourceParticleSystemSet;
    }
